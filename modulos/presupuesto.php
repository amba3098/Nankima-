...
if ($_SESSION["perfil"] == "Administrador") {
  ...
  foreach ($categorias as $key => $value) {
    $options .= '<option value="'.$value["categoria"].'">'.$value["categoria"].'</option>';
  }

  echo '<div style="display:flex; align-items: center;justify-content: space-between;width:23%"><h3>Filtro de Busqueda:</h3> <select id="filtroCategorias" name="categorias" class="form-control" style="width:200px">'.$options.'</select></div>';
}
?>   
</div> 
<div class="box-body">        
   <table class="table table-bordered table-striped dt-responsive tablaProyectos" id="tablaProyectos" width="100%">         
        <thead>         
         <tr>           
...
<!--=====================================
script del filtro de proyectos
======================================-->
<script>
        ...
        <div class="modal-body">
          <div class="box-body">
            ...
            <div class="form-group">              
              ...
              <img src="vistas/img/Proyectos/default/anonymous.png" class="img-thumbnail previsualizar" width="100px">
            </div>
          </div>
        </div>
        <!--=====================================
